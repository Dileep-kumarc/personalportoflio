        ...
        <>
            {meteorStyles.map((style, idx) => (
                <span
                    key={"meteor" + idx}
                    className={cn(
                        "animate-meteor-effect absolute top-1/2 left-1/2 h-0.5 w-0.5 rounded-[9999px] bg-black dark:bg-slate-500 shadow-[0_0_0_1px_#00000040] dark:shadow-[0_0_0_1px_#ffffff10] rotate-[215deg]",
